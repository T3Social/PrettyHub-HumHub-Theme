...
<head>
	...
	<meta name="description" content="KedaiKopi - Spaces to gather and socialize for all without distinction of social strata or Tribe, Indegenous, Race and Religious Affairs.">
	<?= Html::csrfMetaTags() ?>
	<?php $this->head() ?>
